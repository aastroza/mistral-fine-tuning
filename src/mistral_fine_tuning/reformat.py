# Code from here: https://raw.githubusercontent.com/mistralai/mistral-finetune/main/utils/reformat_data.py
...
def reformat_jsonl(input_file):
    # get only the filename from input_file
    input_filename = os.path.basename(input_file)
    output_file = "../data/processed/reformatted_" + input_filename
